exports.handler = async function(event) {
  ...
  try {
    ...
    const SYS = [
      ...
      '4. Collect in this order: first and last name, zip code, email address, phone number, then ask: Do you agree to receive communications from Sea Breeze Propane?',
      '5. After collecting all info including communication consent say: ' + callbackMsg,
      'COMMERCIAL LEADS: Detect warehouse, fleet, forklifts, restaurant, agriculture, port. Ask qualifying questions. Promise specialist callback within 2 hours. Collect company name, first and last name, zip code, email, phone, and ask for communication consent.',
